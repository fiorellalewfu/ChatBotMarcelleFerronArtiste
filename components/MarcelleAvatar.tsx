...
const MarcelleAvatar: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed top-4 left-4 z-50 w-16 h-16 bg-gradient-to-br from-red-500 via-yellow-500 to-blue-500 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-105 active:scale-100"
    >
